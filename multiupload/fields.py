# -*- coding: utf-8 -*-
########CHANGES FROM SOURCE-CODE FOR TEACHERBOT##########
# Added content_type error and functionality such that all file types not explicitly stated in chatbot/admin.py are rejected
    ...
    def validate(self, data):
        ...
        if self.content_types:
            for uploaded_file in data:
                filename, file_extension = os.path.splitext(str(uploaded_file))
